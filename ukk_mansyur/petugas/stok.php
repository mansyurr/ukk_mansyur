                    ...
                    <div class="table-responsive">
                     ...
                     $sql = $koneksi->query("SELECT * FROM produk");
                            ...
                            <tr>
                                ...
                                <td><a type='button' href='?page=editbarang&idproduk=<?= $data['idproduk']; ?>' class='btn btn-sm btn-warning'>Edit</a> <a type='button' href='?page=hapusbarang&idproduk=<?= $data['idproduk']; ?>' class='btn btn-sm btn-danger'>Delete</a></td>
                                <td>
